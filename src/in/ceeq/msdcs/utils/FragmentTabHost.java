...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
	...
	static final class TabInfo {
		...
		TabInfo(String _tag, Class<?> _class, Bundle _args, int _icon) {
			tag = _tag;
			clss = _class;
			args = _args;
			icon = _icon;
	...
	public void addTab(TabHost.TabSpec tabSpec, Class<?> clss, Bundle args, int icon) {
		tabSpec.setContent(new DummyTabFactory(mContext));
		String tag = tabSpec.getTag();

		TabInfo info = new TabInfo(tag, clss, args, icon);
	...
	protected void onAttachedToWindow() {
		...
		mAttached = true;
		/*
		 * ft = doTabChanged(currentTab, ft); if (ft != null) { ft.commit();
	...
	public ArrayList<TabInfo> getTabsList() {
		return mTabs;
	}
}